...
export interface PushNotification{
  body?:string; icon?:string;tag?:string;sch?:number;data?:any;renotify?:boolean;silent?:boolean;sound?:string;noscreen?:boolean;
...
_notify.onclose=function(){
 ...
 generateBreak(source:Array<any>):void{
  let self=this;
  source.forEach((item)=>{
    let options={
